                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link fs-6 fw-bold" id="nav-2-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">
                                    لیست خرید بعدی
                                    <span class="counter fa-num">1</span>
                                </button>
                            </div>
                        </nav>
                        <!-- end of nav-tabs -->
                                        ...
                                        <div class="cart-items">
                                            ...
                                            <div class="cart-item">
                                                ...
                                                <div class="cart-item--detail">
                                                    <h2 class="cart-item--title mb-2"><a href="#">هدفون بی سیم سامسونگ
                                                            مدل
                                                            Galaxy Buds
                                                            Live</a></h2>
                                                    ...
                                                    <div class="cart-item--price--actions">
                                                        <div class="cart-item--actions">
                                                            ...
                                                            <button class="btn btn-link btn-sm text-secondary"><i
                                                                    class="ri-delete-bin-5-line me-1"></i><span>حذف</span></button>
                                                            <button class="btn btn-link btn-sm text-secondary"><i
                                                                    class="ri-anticlockwise-2-line me-1"></i><span>ذخیره
                                                                    در لیست
                                                                    خرید
                                                                    بعدی</span></button>
                                                        </div>
                                            ...
                                            <div class="cart-item">
                                                ...
                                                <div class="cart-item--detail">
                                                    <h2 class="cart-item--title mb-2"><a href="#">گوشی موبایل اپل مدل
                                                            iPhone 13
                                                            A2634 دو
                                                            سیم‌ کارت ظرفیت 128 گیگابایت و رم 4 گیگابایت</a></h2>
                                                    <div class="cart-item--variant mb-2">
                                            ...
                                            <div class="cart-item">
                                                ...
                                                <div class="cart-item--detail">
                                                    <h2 class="cart-item--title mb-2"><a href="#">
                        ...
                        <div class="ui-sticky ui-sticky-top">
                            ...
                            <div class="checkout-bill ui-box bg-white mb-5">
                                ...
                                <div class="checkout-bill-row">
                                    ...
                                    <div class="checkout-bill-row-value"><span class="fs-6">۴۲,۴۱۵,۰۰۰</span> <span
                                            class="currency">تومان</span>
                                    </div>
                                </div>
